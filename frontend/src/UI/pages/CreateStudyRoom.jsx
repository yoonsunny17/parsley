  ...
  return (
    <div className="text-extra5">
      ...
      <div className="flex flex-col rounded-3xl shadow-md px-8 py-9">
        ...
        <form onSubmit={handleSubmit(onSubmit)} onKeyPress={handleEnter}>
          <div className="my-12 flex flex-col gap-7">
              ...
              <div>
                <input
                  {...register("name", {
                    required: {
                      value: true,
                      message: "스터디룸 이름을 입력해주세요",
                    },
                    minLength: {
                      value: 2,
                      message: "최소 2글자, 최대 20글자 입력해주세요",
                    },
                    maxLength: {
                      value: 20,
                      message: "최소 2글자, 최대 20글자 입력해주세요",
            ...
            <div className="flex align-top mb-2">
              ...
              {/* mode */}
              <input {...register("mode")} type="radio" id="cam" value="0" />
              <label htmlFor="cam" className="ml-2 mr-4">
                손꾸락 모드
              </label>

              <input {...register("mode")} type="radio" id="screen" value="1" />
              ...
              <div className="w-7/12">
                <textarea
                  {...register("description", {
                    required: {
                      value: true,
                      message: "스터디룸 설명을 입력하세요",
                    },
                    minLength: {
                      value: 3,
                      message: "최소 3글자, 최대 255글자 입력해주세요",
                    },
                    maxLength: {
                      value: 255,
                      message: "최소 3글자, 최대 255글자 입력해주세요",
            ...
            <div className="flex align-top">
              ...
              <input
                {...register("password", {
                  required: {
                    value: getValues("isPublic") === "private",
                    message: "비밀번호를 입력해주세요",
                  },
                })}
                disabled={!(getValues("isPublic") === "private")}
                name="password"
