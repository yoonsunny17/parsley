...
function Notification({ notiArr, uncheckedCnt, onClick }) {
    ...
    return (
        <div className="dropdown">
            ...
            <div className="dropdown-content menu mt-[10px] shadow-lg bg-white overflow-auto rounded-box w-[260px] min-h-max max-h-80 absolute top-[35px] right-[-118px] pb-1 scrollbar-hide">
