    ...
    return (
        <header className="h-[72px] flex justify-between items-center mt-0 mb-4">
            ...
            <div className="flex items-center gap-[25px] relative">
                <div className="dropdown">
                    ...
                    <div tabIndex="0" className="dropdown-content menu p-[20px] mt-[10px] shadow border-[1px] border-sub1 bg-white rounded-box w-[280px] h-[350px] absolute top-[35px] right-[-145px]">
                        <div className="flex justify-between mb-[20px]">
                            <div className="text-[18px] font-bold">{moment().format("YYYY. M. D (ddd)")}</div>
                            <button className="border-[2px] border-main rounded-[50px] p-[5px_10px] text-[10px] hover:bg-main hover:text-font3">모두 지우기</button>
                        </div>
                        <div className="font-basic border-b-[1px] border-main">알림</div>
                    </div>
                </div>
                <Link to="/room/create">
                    <Button text={"스터디룸 생성"} />
                ...
                <SearchBar />
                {/* Menu Button */}
                <label htmlFor="my-drawer-4" className="drawer-button text-4xl cursor-pointer">
