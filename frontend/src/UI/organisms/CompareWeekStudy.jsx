...
function CompareWeekStudy() {
  ...
  const [thisAvgTime, setThisAvgTime] = useState("0.00");
  const [lastAvgTime, setLastAvgTime] = useState("0.00");
      ...
      <div className="mt-4">
        <div className="flex justify-between items-center">
          <div className="flex font-bold text-[24px] items-center gap-[5px]">
            {lastAvgTime}{" "}
            <span className="text-[12px] mt-[2px] text-[#979797]">시간/일</span>
          </div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex font-bold text-[24px] mt-[10px] items-center gap-[5px]">
            {thisAvgTime}{" "}
            <span className="text-[12px] mt-[5px] text-[#979797]">시간/일</span>
          </div>
