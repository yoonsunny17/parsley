  ...
  return (
    <div className="container max-auto flex flex-wrap justify-between mb-20">
      ...
      <div className="study-contents flex flex-col gap-3 w-2/3 lg:w-7/12 min-h-min">
        <div className="text-2xl font-semibold mb-2">모각코 스터디 모여라!</div>
        ...
        <div className="mb-6">
          <div className="text-xl font-bold mb-2">스터디 규칙 안내</div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="dropdown">
            <button tabIndex="0" className="text-3xl text-font1 rounded-[50px]">
              <i className="bx bx-link"></i>
            </button>
            <ul
              tabIndex="0"
              className="dropdown-content menu p-2 shadow bg-white border-[2px] border-sub1 rounded-box w-52"
            >
              <button
                onClick={onClick}
                className="flex justify-center items-center font-basic font-semibold"
              >
                링크 복사하기
              </button>
            </ul>
          ...
          {!like && (
            <button
              onClick={clickLike}
              className="text-3xl text-heart rounded-[50px]"
            >
