...
// let selectedItems = new HerbItemsStoreModal();

// class SelectItemList extends React.Component {
//   constructor(props) {
//     super(props);
...
//                 }
//               />
//               <p>{this.state.selectedFertilizerName}씨앗</p>
//             </div>

//             <span className="flex badge">
//               {this.state.selectedFertilizerPrice}슬리
//             </span>
//           </div>
...
//                 }
//               />
//               <p>{this.state.selectedFertilizerName}비료</p>
//             </div>
//             <span className="flex badge">
//               {this.state.selectedFertilizerPrice}슬리
//             </span>
...
//               <p>{this.state.selectedWaterName}물뿌리개</p>
//             </div>
//             <span className="flex badge">
//               {this.state.selectedWaterPrice} 슬리
//             </span>
//           </div>
//         </div>
